...
extern unsigned StrToPolStr (const char *, char *, unsigned);
//---------------------------------------------------------------------------
...
extern char *CreatePolStr(const char *, unsigned);
//---------------------------------------------------------------------------
...
extern double EvalStr(const char *, double, unsigned = 0);
//---------------------------------------------------------------------------
...
// EvalStr.
extern double EvalStr(const char *, const double *, unsigned, unsigned = 0, unsigned = 0);
//---------------------------------------------------------------------------
...
extern double EvalPolStr(const char *, double, unsigned = 0);
//---------------------------------------------------------------------------
...
// вторую производные.
extern double EvalPolStr(const char *, const double *, unsigned = 0, unsigned = 0);
//---------------------------------------------------------------------------
#endif
//---------------------------------------------------------------------------
